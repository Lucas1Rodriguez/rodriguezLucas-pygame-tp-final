...
class Auxiliar:
    ...
    @staticmethod
    def getSurfaceFromSeparateFiles(path_format,from_index,quantity,flip=False,flip_y=False,step = 1,scale=1,w=0,h=0,repeat_frame=1):
        lista = []
        for i in range(from_index,quantity+from_index):
            ...
            if(flip):
                ...
                surface_fotograma = pygame.transform.flip(surface_fotograma,False,True).convert_alpha() 
